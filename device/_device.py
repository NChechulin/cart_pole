...
from device.wire_interface import (DeviceConfig, DeviceState, DeviceTarget,
                                   ProtobufWireInterface, WireInterface)
...
class CartPoleDevice(CartPoleBase):
    def __init__(
        self, interface: WireInterface = None, target_key="acceleration"
    ) -> None:
