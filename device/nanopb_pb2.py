...
_FIELDTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="FT_DEFAULT", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FT_CALLBACK", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FT_POINTER", index=2, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FT_STATIC", index=3, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FT_IGNORE", index=4, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FT_INLINE", index=5, number=5, serialized_options=None, type=None
        ),
    ],
...
_INTSIZE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="IS_DEFAULT", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IS_8", index=1, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IS_16", index=2, number=16, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IS_32", index=3, number=32, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IS_64", index=4, number=64, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_TYPENAMEMANGLING = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="M_NONE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="M_STRIP_PACKAGE",
            index=1,
            number=1,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="M_FLATTEN", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="M_PACKAGE_INITIALS",
            index=3,
            number=3,
            serialized_options=None,
            type=None,
...
_DESCRIPTORSIZE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="DS_AUTO", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DS_1", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DS_2", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DS_4", index=3, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DS_8", index=4, number=8, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_NANOPBOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="proto3_singular_msgs",
            full_name="NanoPBOptions.proto3_singular_msgs",
            index=13,
            number=21,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="submsg_callback",
            full_name="NanoPBOptions.submsg_callback",
            index=17,
            number=22,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            label=1,
            has_default_value=True,
            default_value=b"pb_callback_t".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            ...
            label=1,
            has_default_value=True,
            default_value=b"pb_default_field_callback".decode("utf-8"),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
        ...
        _descriptor.FieldDescriptor(
            name="default_has",
            full_name="NanoPBOptions.default_has",
            index=22,
            number=23,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="include",
            full_name="NanoPBOptions.include",
            index=23,
            number=24,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="exclude",
            full_name="NanoPBOptions.exclude",
            index=24,
            number=26,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="package",
            full_name="NanoPBOptions.package",
            index=25,
            number=25,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type_override",
            full_name="NanoPBOptions.type_override",
            index=26,
            number=27,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="sort_by_tag",
            full_name="NanoPBOptions.sort_by_tag",
            index=27,
            number=28,
            type=8,
            cpp_type=7,
...
_NANOPBOPTIONS.fields_by_name[
    "type_override"
].enum_type = google_dot_protobuf_dot_descriptor__pb2._FIELDDESCRIPTORPROTO_TYPE
